...
public class ParameterVariableAspect extends VariableAspect {
  public static String generate(final ParameterVariable _self) {
    ...
    Object result = null;
    // #DispatchPointCut_before# String generate()
    if (_self instanceof org.eclipse.ocl.pivot.ParameterVariable){
    	result = fr.inria.diverse.swhModel.generator.aspects.ParameterVariableAspect._privk3_generate(_self_, (org.eclipse.ocl.pivot.ParameterVariable)_self);
    };
    return (java.lang.String)result;
  }
  
  protected static String _privk3_generate(final ParameterVariableAspectParameterVariableAspectProperties _self_, final ParameterVariable _self) {
    return null;
  }
}
