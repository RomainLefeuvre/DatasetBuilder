...
public abstract class PrimitiveLiteralExpAspect extends LiteralExpAspect {
  public static String generate(final PrimitiveLiteralExp _self, final Context context) {
    ...
    Object result = null;
    	...
    	// BeginInjectInto fr.inria.diverse.swhModel.generator.aspects.PrimitiveLiteralExpAspect#String generate(Context) from fr.inria.diverse.swhModel.generator.aspects.NullLiteralExpAspect
    		...
    		// EndInjectInto fr.inria.diverse.swhModel.generator.aspects.PrimitiveLiteralExpAspect#String generate(Context) from fr.inria.diverse.swhModel.generator.aspects.NullLiteralExpAspect
